      ...
      <div className="rounded-xl bg-white border justify-around py-10 flex flex-col lg:flex-row hover:border-orange-300 ">
        ...
        <div className="flex flex-col gap-12 p-6">
          <div className="h-4 w-fit">
            <img src="/images/asset 44.svg" className="w-32" />
          </div>
          ...
          <p className="leading-relaxed font-display text-gray-500">
          ...
          <div id="user-card" className="flex gap-4">
            ...
            <div id="info" className="flex flex-col gap-0.5">
              ...
              <p className="text-gray-700">
                Founder & CEO,{" "}
                <a className="cursor-pointer border-b-[2px] border-dotted border-gray-200 hover:border-solid hover:border-black hover:border-b-[1px]">
                  ClickUp
                </a>
              </p>
            </div>
        ...
        <div className="flex items-end ">
          <img src="/images/asset 46.png" className="pl-12 w-full h-full" />
        </div>
      </div>
