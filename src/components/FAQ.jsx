            ...
            {toggle ?
                ...
                <div>
                    <dt className='flex justify-between items-center'>
                        ...
                        <i className='fa-solid fa-chevron-up -rotate-180 transition duration-300 cursor-pointer' onClick={toggleButton}></i>
                ...
                <div>
                    <dt className='flex justify-between items-center'>
                        ...
                        <i className='fa-solid fa-chevron-up transition duration-300 cursor-pointer' onClick={toggleButton}></i>
